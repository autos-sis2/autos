...
public class Formulario extends javax.swing.JFrame {
    ...
    public boolean datosNulos(String nombre) {
        return nombre.isEmpty() ? true : false;
    }

    public boolean verificarNumeros(String dato)
    {
     return ((dato).matches("([0-9]|\\s)+")) ? true : false;
    }
    public boolean verificarLetras(String cad) {
        
        return ((cad).matches("([a-z]|[A-Z]|\\s)+")) ? true :false;
    }
