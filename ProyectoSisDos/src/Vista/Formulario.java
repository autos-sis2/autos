...
public class Formulario extends javax.swing.JFrame {
    ...
    private void jbAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAgregarActionPerformed
        ...
        bd.añadir_nuevo_empleado(txtNombre1.getText(),txtApellido1.getText(),cbSexo.getSelectedItem().toString(),txtCorreo1.getText(), txtCI.getText(),txtFechaIngreso.getText(),cbCargo.getSelectedItem().toString(),Integer.valueOf( txtSalario1.getText()),txtDireccion1.getText());
