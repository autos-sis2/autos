...
public class ConsultarRepuesto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CONSULTAR   REPUESTO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarRepuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarRepuesto().setVisible(true);
            }
        });
    }
